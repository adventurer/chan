...
func main() {
	...
	flag.StringVar(&flags.AuthAddr, "authaddr", "https://admin.jiasu.zhifool.com/api/v1/user/usertimecheck", "auth api address")
	...
	if flags.Client != "" { // client mode
		...
		if flags.Socks != "" {
			...
			go socksLocal(flags.Socks, addr, ciph.StreamConn, flags.AuthAddr)
			if flags.UDPSocks {
